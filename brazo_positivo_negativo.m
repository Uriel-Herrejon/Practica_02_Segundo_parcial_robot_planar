...
for  i=1:length(angVec) % Se encarga de realizar una animación de la 
    ...
    p2 = T1 (1:3,4); % Se encarga de tomar la posicion final de la matriz 
                     ...
                     % 4
    eje_x_1 = T1(1:3,1); % Se establece el punto de referencia en el punto 
                         % del eje x sobre el origen del primer eslabón
    eje_y_1 = T1(1:3,2); % Se establece el punto de referencia en el punto 
                         % del eje Y sobre el origen del primer eslabón
                
    line([p1(1) p2(1)],[p1(2) p2(2)],[p1(3) p2(3)],'linewidth',4) % Se realiza la impres-
                                                                  % ión final del eslabon 1 
    
       % En la siguiente línea se traza la linea que hace como referencia 
       % al eje x de un marco de referencia sobre el origen del primer 
       % eslabón 
...
%------------Bloque de articulación 2 en estado inicial--------------------
    ...
    p3 = Tf (1:3,4); % Se encarga de tomar la posicion final de la matriz 
                     ...
                     % 4
    eje_x_2 = p2 + Tf(1:3,1); % Se establece el punto de referencia en el punto 
                              % del eje x sobre el origen del segundo eslabón
    eje_y_2 = p2 + Tf(1:3,2); % Se establece el punto de referencia en el punto 
                              % del eje y sobre el origen del segundo eslabón
    eje_x_3 = p3 + Tf(1:3,1); % Se establece el punto de referencia en el punto 
                              % del eje x sobre el punto final  del segundo eslabón
    eje_y_3 = p3 + Tf(1:3,2); % Se establece el punto de referencia en el punto 
                              % del eje y sobre el punto final  del segundo eslabón
      
    line([p2(1) p3(1)],[p2(2) p3(2)],[p2(3) p3(3)],'color',[0 1 1],'linewidth',2.5);
                     % Se realiza la impresión final del eslabon 2 
                     
       % En la siguiente línea se traza la linea que hace como referencia 
       % al eje x de un marco de referencia sobre el origen del segundo
       % eslabón 
    line([p2(1) eje_x_2(1)],[p2(2) eje_x_2(2)],[p2(3) eje_x_2(3)],'linewidth',5,'color',[0 0 0]) 
    
       % En la siguiente línea se traza la linea que hace como referencia 
       % al eje y de un marco de referencia sobre el origen del segundo
       % eslabón 
    line([p2(1) eje_y_2(1)],[p2(2) eje_y_2(2)],[p2(3) eje_y_2(3)],'linewidth',5,'color',[0 0 0])
    
       % En la siguiente línea se traza la linea que hace como referencia 
       % al eje x de un marco de referencia sobre el punto final del segundo
       % eslabón 
    line([p3(1) eje_x_3(1)],[p3(2) eje_x_3(2)],[p3(3) eje_x_3(3)],'linewidth',5,'color',[0 0 0]) 
    
       % En la siguiente línea se traza la linea que hace como referencia 
       % al eje y de un marco de referencia sobre el punto final del segundo
       % eslabón 
...
if angrad2>=0 % Sí el ángulo es mayor o igual a 0 hace la siguiente acción 
    angVec2 = 0:0.01:angrad2; % El ángulo del vector va incrementar en 0.01°
                           % desde 0 hasta el águlo indicado por el usuario
                           % sobre el eje positivo.
else % Sí no cumple la condición realiza lo siguiente 
    
    angVec2 = 0:-0.01:angrad2;% El ángulo del vector va a decrementar en -0.01°
                           % desde 0 hasta el águlo indicado por el usuario
                           % sobre el eje negativo.
end
%--------------------------------------------------------------------------
...
%-----bloque de ciclo for para realizar la animación e ir imprimiendo las 
% lineas de la rotación de la articulación 2-------------------------------
for i=1:length(angVec2)% Se encarga de realizar una animación de la 
                        % segunda articulación  que va incrementando desde
                        % 1 hasta el ángulo que el usuario introdujo en 
                        % angdeg con un incremento 0.01 en 
    ...
    line([p1(1) p2(1)],[p1(2) p2(2)],[p1(3) p2(3)],'linewidth',4) % Se realiza la impres-
       ...
       % En la siguiente línea se traza la linea que hace como referencia 
       % al eje x de un marco de referencia sobre el origen del segudno eslabón                                                                  
    line([p1(1) eje_x_1(1)],[p1(2) eje_x_1(2)],[p1(3) eje_x_1(3)],'linewidth',5,'color',[0 0 0]) 
    
       % En la siguiente línea se traza la linea que hace como referencia 
       % al eje x de un marco de referencia sobre el origen del segundo eslabón
    line([p1(1) eje_y_1(1)],[p1(2) eje_y_1(2)],[p1(3) eje_y_1(3)],'linewidth',5,'color',[0 0 0])
%--------------------------------------------------------------------------------------------------------
    ...
    % Se establece el punto de referencia en el punto 
    % del eje y sobre el punto final  del segundo eslabón
    eje_x_2 = p2 + Tf(1:3,1);
    % Se establece el punto de referencia en el punto 
    % del eje x sobre el origen del segundo eslabón
